...
export default function Home() {
  return (
    <div className='bg-[rgb(36,36,36)] text-white h-screen snap-y snap-mandatory overflow-y-scroll overflow-hidden z-0 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#a393eb]/80'>
      <Head>
